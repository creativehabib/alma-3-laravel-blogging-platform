import{C as r}from"./app-DKvfoN-y.js";function o(a,l){for(var t=0;t<l.length;t++){const e=l[t];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in a)){const c=Object.getOwnPropertyDescriptor(e,n);c&&Object.defineProperty(a,n,c.get?c:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}};(function(a,l){ace.define("ace/theme/github_light_default-css",["require","exports","module"],function(t,e,n){n.exports=`.ace-github-light-default .ace_gutter {
    background: #ffffff;
